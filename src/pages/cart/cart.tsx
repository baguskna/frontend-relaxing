  ...
  return (
    <div>
      ...
      <div className="py-6 px-4 lg:px-[55px] max-w-[1440px] lg:mx-auto lg:pt-8 sm:flex sm:flex-row sm:justify-between">
        ...
        <div>
          <div className="mt-[21px] border border-grey-300 rounded p-4 bg-grey-050 sm:mt-0">
            <div className="flex items-center justify-between">
              <p className="font-normal text-grey-700 text-xs">Harga barang</p>
            ...
            <div className="flex items-center justify-between pt-2">
              <p className="font-bold text-grey-700 text-xs">Total Tagihan</p>
